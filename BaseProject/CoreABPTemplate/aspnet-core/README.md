...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f771c751-4401-4e28-ab71-913f8d75d8be
```

> `f771c751-4401-4e28-ab71-913f8d75d8be` is the password of the certificate, you can change it to any password you want.
