...
public class BookStoreModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "5890eb2a-a977-420c-b72c-b631a03f10f5");
            });
        }
    }
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("BookStore");
    }
